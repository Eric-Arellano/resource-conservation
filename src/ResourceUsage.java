...
abstract public class ResourceUsage 
{
	...
	private Tips tips; // (composition)
	private AverageUsage avg; // (composition)
	private HistoricalUsage hist; // (composition)
	...
	// Constructors
	// ================================================================================
	public ResourceUsage(String name, double rate, String unit, Tips tips, AverageUsage avg, 
	...
	public ResourceUsage(String name, double rate, String unit, HistoricalUsage historical)
	{
		this.name = name;
		this.rate = rate;
		this.usageUnit = unit;
	...
	public double getUsageAmt() { return usageAmt; }
	...
	public void setInputAmt(double input) { this.inputAmt = input; }
	public void setUsageUnit(String unit) { this.usageUnit = unit; }
	public void setTips(Tips tips) { this.tips = tips; }
	public void setAvg(AverageUsage avg) { this.avg = avg; }

...
public class UsageDuration extends ResourceUsage
{
	 ...
	 * @param avg
	 */
	public UsageDuration (String name, double rate, String usageUnit, String timeType, Tips tips,
			AverageUsage avg, HistoricalUsage historical)
	{
	 ...
	 * @param timeType - how time will be inputted; expected "seconds", "minutes", or "both"
	 */
	public UsageDuration (String name, double rate, String usageUnit, String timeType, 
	...
	{
		if (getInputUnit().equalsIgnoreCase("seconds")) { promptSec(); }
		else if (getInputUnit().equalsIgnoreCase("minutes")) { promptMin(); }
		else if (getInputUnit().equalsIgnoreCase("both")) { promptBoth(); }
		else 
		{ 
			promptTimeType();
			promptInput();
	...
	public void promptTimeType()
	{
		...
		while (!flag)
		{
			...
			type = in.next();
			if (type.equals("minutes")) { flag = true; }
			if (type.equals("seconds")) { flag = true; }
			if (type.equals("both")) { flag = true; }
		}
		setInputUnit(type);
	}
}

...
public class HistoricalUsageTest {
	...
	public static class NoPriorData {
		...
		public void compareHistorical_NoData() {
			HistoricalUsage sampleHistorical = new HistoricalUsage();
			String returnedMessage = sampleHistorical.compareHistorical(30, "gal", "shower", 2);
	...
	public static class OnePriorDatum {
		...
		public void setUpOnePriorDatum() throws Exception {
			sampleHistorical = new HistoricalUsage();
			sampleHistorical.preFillData(2, 10); // rate 2; input 10 min (usage 20)
		}

		@Test
		public void compareHistorical_OneDatum_Less() {
			String returnedMessage = sampleHistorical.compareHistorical(10, "gal", "shower", 2);
		...
		public void compareHistorical_OneDatum_Equal() {
			String returnedMessage = sampleHistorical.compareHistorical(20, "gal", "shower", 2);
	...
	public static class PriorData {
		...
		public void compareHistorical_EqualAvg() {
			String returnedMessage = sampleHistorical.compareHistorical(40, "gal", "shower", 2);
		...
		public void compareHistorical_GreaterAvg_LessOrEqualToMax() {
			String returnedMessage = sampleHistorical.compareHistorical(50, "gal", "shower", 2);
		...
		public void compareHistorical_GreaterMax() {
			String returnedMessage = sampleHistorical.compareHistorical(80, "gal", "shower", 2);
